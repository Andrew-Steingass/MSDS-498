...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'main_allstar'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "AllstarFull.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'AllStar'                          ##  What table do you want to push into

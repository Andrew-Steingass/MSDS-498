...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'Batting'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "Batting.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'Batting'                          ##  What table do you want to push into

...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'AwardsShareManagers'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "AwardsShareManagers.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'AwardsShareManagers'                          ##  What table do you want to push into

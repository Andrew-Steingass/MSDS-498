...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'BattingPost'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "BattingPost.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'BattingPost'                          ##  What table do you want to push into

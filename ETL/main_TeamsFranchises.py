...
rename_dict = {
    ...
    "active": "active_flag",
    "NAassoc": "na_association"
}

schema_dict = {
    "franchise_id": "VARCHAR(255)",
    "franchise_name": "VARCHAR(255)",
    "active_flag": "VARCHAR(255)",   # often Y/N
    "na_association": "VARCHAR(255)"
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'TeamsFranchises'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "TeamsFranchises.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'TeamsFranchises'                          ##  What table do you want to push into

...
schema_dict = {
    ...
    "tie_flag": "VARCHAR(255)",
    "notes": "FLOAT"
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'AwardsManager'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "AwardsManagers.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'AwardsManagers'                          ##  What table do you want to push into

...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'AwardsPlayers'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "AwardsPlayers.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'AwardsPlayers'                          ##  What table do you want to push into

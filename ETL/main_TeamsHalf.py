...
schema_dict = {
    ...
    "division_winner_flag": "VARCHAR(255)",  # often Y/N
    "division_rank": "INT",
    "games_played": "INT",
    "wins": "INT",
    "losses": "INT"
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'TeamsHalf'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "TeamsHalf.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'TeamsHalf'                          ##  What table do you want to push into

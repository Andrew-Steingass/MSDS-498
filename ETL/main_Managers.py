...
rename_dict = {
    ...
    "teamID": "team_id",
    "lgID": "league_id",
    "inseason": "in_season_flag",
    "G": "games_managed",
    "W": "wins",
    "L": "losses",
    "rank": "team_rank",
    "plyrMgr": "player_manager_flag"
}
...
schema_dict = {
    ...
    "losses": "INT",
    "team_rank": "FLOAT",
    "player_manager_flag": "VARCHAR(255)"
}

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'Managers'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "Managers.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'Managers'                          ##  What table do you want to push into

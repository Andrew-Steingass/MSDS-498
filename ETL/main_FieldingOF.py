...
rename_dict = {
    ...
    "yearID": "season_year",
    "stint": "stint_number",
    "Glf": "games_left_field",
    "Gcf": "games_center_field",
    "Grf": "games_right_field"
}
...
schema_dict = {
    ...
    "season_year": "INT",
    "stint_number": "INT",
    "games_left_field": "FLOAT",
    "games_center_field": "FLOAT",
    "games_right_field": "FLOAT"
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'FieldingOF'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "FieldingOF.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'FieldingOF'                          ##  What table do you want to push into

...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'Salaries'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "Salaries.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'Salaries'                          ##  What table do you want to push into

...
schema_dict = {
    ...
    "inducted_flag": "VARCHAR(255)",   # often 'Y'/'N'
    "category": "VARCHAR(255)",
    "needed_note": "VARCHAR(255)"
}

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'HallOfFame'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "HallOfFame.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'HallOfFame'                          ##  What table do you want to push into

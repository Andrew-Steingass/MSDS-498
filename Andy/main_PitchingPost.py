...
schema_dict = {
    ...
    "batting_avg_against": "VARCHAR(255)",  # preserved as provided
    ...
    "games_finished": "INT",
    "runs_allowed": "INT",
    "sacrifice_hits_allowed": "FLOAT",
    "sacrifice_flies_allowed": "FLOAT",
    "grounded_into_double_play": "FLOAT"
}

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'PitchingPost'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "PitchingPost.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'PitchingPost'                          ##  What table do you want to push into

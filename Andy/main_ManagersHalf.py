...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'ManagersHalf'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "ManagersHalf.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'ManagersHalf'                          ##  What table do you want to push into

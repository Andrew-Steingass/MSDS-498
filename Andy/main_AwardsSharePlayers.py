...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'AwardsSharePlayers'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "AwardsSharePlayers.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'AwardsSharePlayers'                          ##  What table do you want to push into

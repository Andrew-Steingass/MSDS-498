...
rename_dict = {
    "yearID": "season_year",
    "round": "round_name",
    "teamIDwinner": "winning_team_id",
    "lgIDwinner": "winning_league_id",
    "teamIDloser": "losing_team_id",
    "lgIDloser": "losing_league_id",
    "wins": "winning_team_wins",
    "losses": "losing_team_wins",
    "ties": "ties"
}
...
schema_dict = {
    ...
    "winning_league_id": "VARCHAR(255)",
    "losing_team_id": "VARCHAR(255)",
    "losing_league_id": "VARCHAR(255)",
    "winning_team_wins": "INT",
    "losing_team_wins": "INT",
    "ties": "INT"
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
script_logging_name = 'SeriesPost'  ##  Use the name of the main pipeline script. 
FILE_PATTERN =  "SeriesPost.csv"                                      ##  Pattern of file to look for within the datafolder
TABLE_NAME = 'SeriesPost'                          ##  What table do you want to push into
